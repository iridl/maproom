...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:wms="http://www.opengis.net/wms#"
   ...
   <head>
      ...
      <title>Ситуационный Центр Международного Научно-Исследовательского Института по вопросам Климата и Общества, Институт Земли при Колумбийском
         университете, США
      </title>
      ...
      <link class="altLanguage" rel="alternate" hreflang="es"
            href="index.html?Set-Language=es" />
   ...
   <body>
      ...
      <div class="controlBar">
         ...
         <fieldset class="navitem">
            ...
            <a rev="section" class="navlink carryup" href="/" shape="rect">Библиотека Климатических Данных</a>
      ...
      <div>
         ...
         <div id="content" class="searchDescription">
            ...
            <h2 property="term:title">Ситуационный Центр МНИИ по вопросам Климата и Общества</h2>
            
            <p align="left" property="term:description">
               Ситуационный Центр по вопросам климата и общества представляет собой коллекцию карт и графиков по наблюдению за климатическими
               и социальными процессами в настоящем и недавнем прошлом. Карты и графики можно перестраивать, а также проследить их зависимость
               от исходных данных. Даже если Вас интересуют не графические представления данных, а сами данные, то здесь Вы быстро сможете
               найти наиболее полезные для Вас наборы данных.
         ...
         <div xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            ...
            <div class="ui-tabs">
               ...
               <div class="ui-tabs-panel">
                  <div class="item">
                     <div class="itemTitle"><a class="carryLanguage carry titleLink" href="Global/index.html">Анализ и Мониторинг Климата</a></div>
                     <div class="itemIcon"><a class="carryLanguage carry titleLink" href="Global/index.html"><img class="itemImage"
                     ...
                     <div class="itemDescription">Текущие и исторические климатические условия вокруг Земли.</div>
                     <div class="itemFooter"></div>
                  </div>
                  <div class="item">
                     <div class="itemTitle"><a class="carry titleLink" href="IFRC/index.html">International Federation of Red Cross and Red Crescent Societies: Forecasts in Context</a></div>
                     <div class="itemIcon"><a class="carry titleLink" href="IFRC/index.html"><img class="itemImage"
                     ...
                     <div class="itemDescription">This collection of maps provides information that can be used for humanitarian decision-making around the world, developed
                        by the IRI and the IFRC. It also provides information on the types of early action that can be taken based on these maps.
                     </div>
                     <div class="itemFooter"></div>
                  </div>
                  <div class="item">
                  ...
                  <div class="item">
                     <div class="itemTitle"><a class="carryLanguage carry titleLink" href="Health/index.html">Климат и Здоровье Населения</a></div>
                     ...
                     <div class="itemDescription">Существует несколько видов влияния климата на здоровье населения. Влияние может быть либо прямым, как при тепловом ударе,
                        либо косвенным, как при инфекционных заболеваниях, таких, например, как малярия и менингит.
                     </div>
                     <div class="itemFooter"></div>
                  </div>
                  <div class="item">
                     <div class="itemTitle"><a class="carry titleLink" href="Food_Security/index.html">Food Security</a></div>
                     <div class="itemIcon"><a class="carry titleLink" href="Food_Security/index.html"><img class="itemImage"

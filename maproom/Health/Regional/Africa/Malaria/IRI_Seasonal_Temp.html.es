...
<link class="altLanguage" rel="alternate" hreflang="en" href="IRI_Seasonal_Temp.html?Set-Language=en" />
...
<div class="controlBar">
           <fieldset class="navitem" id="toSectionList"> 
            ...
            <fieldset class="navitem" id="chooseSection"> 
                <legend about="http://iridl.ldeo.columbia.edu/ontologies/iridl.owl#Seasonal_Climate_Forecast"><span property="term:label">Seasonal Climate Forecast</span></legend>
            </fieldset> 
...
<p align="left" property="term:description">This map shows seasonal temperature forecasts from the International Research Institute for Climate and Society. In areas of Africa where temperature drives mosquito vector development and parasite development, skillful seasonal temperature forecasts may provide early warning of risk of an epidemic.</p>
...
<h4>References:</h4>
<p>Barnston, A., Mason, S., Goddard, L., DeWitt, D., Zebiak, S.(2003). <a href="http://www.inmet.gov.br/documentos/cursoI_INMET_IRI/Climate_Information_Course/References/Barnston_etal_2003.pdf">Multimodel Ensembling in Seasonal Climate Forecasting at IRI</a>. Amer. Met. Soc. 84 (12): 1783-1796.
</p>

<p>Goddard, L., Graham, NE.(1999). <a href="http://www.ldeo.columbia.edu/~peter/site/Seminar_files/Goddard.Grahm.1999.pdf">Importance of the Indian Ocean for simulating rainfall
anomalies over eastern and southern Africa</a>. J. Geo. Res., 104, 19099-19116.
</p>
...
<p>
<a href="http://iridl.ldeo.columbia.edu/expert/SOURCES/.IRI/.FD/.Seasonal_Forecast/.PiC/.pic3mo_same/Y/-85/85/RANGE/X/-180/180/RANGEEDGES/">Access the dataset used to create this map.</a>
</p>
</div>
<div id="tabs-3"  class="ui-tabs-panel">
<h2  align="center">Helpdesk</h2>
<p>
Contact <a href="mailto:help@iri.columbia.edu?subject=Predictions in Context:  Same Tendency in Forecast and 3-Month Precipitation Observation">help@iri.columbia.edu</a> with any technical questions or problems with this Map Room.
 </p>
</div>

...
<p>
La base puede ser un año solo, múltiplos años o un rango de años. Para un año solo, simplemente ingrese los 4 números del año que quiere, como está per defecto. Para múltiplos años, ingrese los 4 números de los años que quiere, separados por un espacio. Por ejemplo, al ingresar <i>1985 1990 2004</i> se selecciona estos 3 años y se calcula el promedio para formar una nueva línea base. Para un rango de años, ingrese los 4 números del primer año y los del último año (incluso) separados por un <i>-</i>. Por ejemplo <i>1990-1999</i> selecciona estos 10 años y calcula el promedio para formar una línea base que representa los 90s. Finalmente, se puede definir un año de otra manera que de Enero a Diciembre al elegir el mes cuando empieza el año. Por ejemplo, elegir <i>Mar</i> define un año como los 12 meces desde Marzo hasta Febrero.
</p>
<p>

...
<div class="controlBar">
           <fieldset class="navitem">
                <legend>Международный Научно-Исследовательский Институт, Институт Земли</legend> 
                      <a rev="section" class="navlink carryup carryLanguage" href="/">Библиотека Климатических Данных</a>
            </fieldset> 
           <fieldset class="navitem"> 
...
Ситуационный Центр по вопросам климата и общества представляет собой коллекцию карт и графиков по наблюдению за климатическими и социальными процессами в настоящем и недавнем прошлом. Карты и графики можно перестраивать, а также проследить их зависимость от исходных данных. Даже если Вас интересуют не графические представления данных, а сами данные, то здесь Вы быстро сможете найти наиболее полезные для Вас наборы данных.
</p>
</div>

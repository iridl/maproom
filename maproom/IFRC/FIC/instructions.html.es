...
<div class="anchorlinks">
 <ul>
 <li><a href="#visual">Características visuales de la interfase del mapa</a></li>
 <li><a href="#interp">Interpretando los mapas</a><br /></li>
 <div class="indented">
  <li><a href="#esrlgfs">Mapas de Pronóstico de la Precipitación de Seis Días y Diario del ESRL GFS</a></li>
  <li><a href="#prcp_fcst">Pronóstico Estacional de Precipitación del IRI</a></li>
  <li><a href="#extreme_prcp_fcst">Pronóstico de la Precipitación Extrema del IRI</a></li>
  <li><a href="#pic3mo_same">Predicciones en Contexto (PiC) del IRI</a></li>
  <li><a href="#CMAP_climo">Climatología Mensual del Merged Analysis of Precipitation (CMAP) del CPC</a></li>
  <li><a href="#count">Población Ajustada Proyectada según las Naciones Unidas del CIESIN/SEDAC</a></li>
  <li><a href="#imr">Tasa de Mortalidad Infantil, Año 2000 del CIESIN/SEDAC Global Distribution of Poverty</a></li>
 </div>
 </ul>
</div>
</p><p>
</p><p>
</p><p><a name="visual" /><u><b>Características visuales de la interfase del mapa</b></u>
En primer lugar el mapa muestra el total de precipitaciones de los seis días más recientes. Los usuarios también pueden usar el visualizador de mapas para:
<ul>
...
Hay botones de radio en el lado izquierdo de la página bajo "¿Que le gustaría saber?".
...
<ul>
 <li><i>Cliquear-y-arrastrar</i>
  ...
  <ol>
   ...
   <li>Suelte el botón izquierdo del Mouse. El mapa se re-dibujará automáticamente.</li>
  </ol>
 <li><i>Selección de lat/lon específica</i>
  Hay cuatro cajas de texto de lat/lon debajo y a la izquierda del mapa.
  </li>
  <ol>
...
Cuando se elige los mapas de pronóstico total de seis días o los mapas de pronóstico estacional del IRI o los mapas de PiC , aparecerá una caja de texto y botones arriba del mapa que permitirá elegir el Tiempo de Inicio de Pronóstico (o el Mes de Publicación del Pronóstico de IRI). El Tiempo de Inicio de Pronóstico del mapa que se está exhibiendo aparece en la caja de texto.
</p><p>Para moverse hacia adelante o atrás un paso en el tiempo (es decir moverse un día en el mapa de pronóstico de seis días y moverse un mes en los mapas de pronóstico del IRI), haga clic sobre los botones correspondientes al lado de la caja de texto.
</p><p>El usuario también puede modificar la fecha en la caja de texto, usando el formato apropiado (por ejemplo "0000 16 Jan 2008", para los mapas de seis días; "Jan 2008" para los mapas de pronóstico del IRI), y luego cliquear el botón de "Redibujar" para ir al pronóstico publicado en esa fecha.
...
<hr width="80%"> </hr>
</p><p><a name="interp" /><u><b>Interpretando los mapas</b></u>
En las secciones siguientes se proporciona una explicación sobre  la interpretación correcta de cada mapa disponible en la interfase.
</p><p>
   <a name="esrlgfs" /><b>Mapas de Pronóstico de Precipitación de Seis Días y Diario del ESRL GEFS</b>
</p><p>
...
</p><p><a name="tot6dayapcp" /><b>Pronóstico de la Precipitación Total de Seis Días del ESRL GEFS</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="tot6dayapcpanom" /><b>Pronóstico de la Anomalía de la Precipitación Total de Seis Días del ESRL GEFS</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="tot6dayapcppctle" /><b>Percentil del Pronóstico de Precipitación Total de Seis Días del ESRL GEFS</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="tot6dayapcppctmonthlyclim" /><b>Pronóstico de Precipitación Total de Seis Días como Porcentaje del Total Mensual Promedio</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="prcp_fcst" /><b>Pronóstico de Precipitación Estacional del IRI</b>
</p><p>
<div class="rightbox">
...
</p><p><b>Referencia:</b>  Barnston, A. G., S. J. Mason, L. Goddard, D. G. Dewitt, and S. E. Zebiak, 2003:  Multimodel ensembling in seasonal climate forecasting at IRI. <i>Bull. Amer. Meteor. Soc.</i>, <b>84</b>, 1783-1796.

</p><p><a name="extreme_prcp_fcst" /><b>Pronóstico de Precipitación Extrema del IRI</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="pic3mo_same" /><b>Predicciones en Contexto (PiC) del IRI: Observación de la misma tendencia en el Pronóstico Estacional y la Precipitación observada en los últimos 3 meses</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="pic3mo_reversed" /><b>Predicciones en Contexto (PiC) del IRI: Tendencia Revertida Entre el Pronóstico Estacional y las Observaciones de Precipitación Trimestral</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="count" /><b>Población Proyectada para el Año 2005 Ajustada por las Naciones Unidas, del CIESIN/SEDAC GPWv3</b>
</p><p>
<div class="rightbox">
...
</p><p><a name="imr" /><b>Tasa de Mortalidad Infantil del CIESIN/SEDAC Global Distribution of Poverty, año 2000</b>
</p><p>
<div class="rightbox">
<a href="imr.html.es">

...
<p>
   <a name="esrlgfs"><b>Mapas de Pron&oacute;stico de Precipitaci&oacute;n de Seis D&iacute;as y Diario del ESRL GEFS</b><br>
<p>
...
<p><a name="tot6dayapcp"><b>Pron&oacute;stico de la Precipitaci&oacute;n Total de Seis D&iacute;as del ESRL GEFS</b>
<p>
<div class="rightbox">
...
<p><a name="tot6dayapcpanom"><b>Pron&oacute;stico de la Anomal&iacute;a de la Precipitaci&oacute;n Total de Seis D&iacute;as del ESRL GEFS</b>
<p>
<div class="rightbox">
...
Este mapa muestra la diferencia (en mil&iacute;metros) entre el valor del pron&oacute;stico actual de la precipitaci&oacute;n total de seis d&iacute;as y el pron&oacute;stico promedio de largo plazo (1985-2012) para seis d&iacute;as en la misma &eacute;poca del a&ntilde;o utilizando la climatolog&iacute;a del modelo. El valor del pron&oacute;stico promedio de largo plazo (1985-2012) se calcula usando grupos de p&eacute;ntadas (5 d&iacute;as) para la precipitaci&oacute;n total de seis d&iacute;as para cada a&ntilde;o utilizando la climatolog&iacute;a del modelo; por lo tanto, el promedio de largo plazo se calcula t&iacute;picamente usando 140 valores. A pesar de que la anomal&iacute;a de la precipitaci&oacute;n expresa cu&aacute;nto difiere el valor del pron&oacute;stico de precipitaci&oacute;n actual con el "normal" de largo plazo, no especifica claramente cu&aacute;n inusual es la diferencia para ese lugar o &eacute;poca del a&ntilde;o en particular. Por ejemplo, mientras una anomal&iacute;a de 30 mm puede ser significativo en el Norte de &aacute;frica, puede ser no significativo en Indonesia.
<p><a name="tot6dayapcppctle"><b>Percentil del Pron&oacute;stico de Precipitaci&oacute;n Total de Seis D&iacute;as del ESRL GEFS</b>
<p>
<div class="rightbox">
...
Este mapa muestra el pron&oacute;stico de percentil de la precipitaci&oacute;n total de seis d&iacute;as con respecto a todos los pron&oacute;sticos de precipitaci&oacute;n de la climatolog&iacute;a del modelo de 1985-2012.  Para determinar el valor de percentil que ser&aacute; asignado al pron&oacute;stico de precipitaci&oacute;n total de seis d&iacute;as actual, se ordenan los pron&oacute;sticos de precipitaci&oacute;n total de seis d&iacute;as de 1985 al 2012 de mayor a menor. De estos, se le asigna un valor de 0 al valor menor, y un valor de 1 al mayor. El valor del pron&oacute;stico de precipitaci&oacute;n actual se compara con estos pares de precipitaci&oacute;n y con los valores de los percentiles climatol&oacute;gicos y se le asigna su rango de percentil dentro de este conjunto. Para hacer &eacute;nfasis sobre los valores de precipitaci&oacute;n que corresponded a percentiles mayores con respecto al modelo hist&oacute;rico, solo se muestran los valores de percentiles mayores a 0.9. Los valores de percentil proporcionan una buena idea de c&oacute;mo el pron&oacute;stico de precipitaci&oacute;n total actual se compara con el registro hist&oacute;rico de un lugar determinado.

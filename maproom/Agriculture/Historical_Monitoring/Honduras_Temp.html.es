...
<title>Monitoreo de la Temperatura Histórica en Honduras SMNH/IRI</title>
...
<meta property="maproom:Entry_Id" content="Agriculture_Historical_Honduras_Temperature" />
...
<link rel="term:icon" href="http://iridl.ldeo.columbia.edu/expert/SOURCES/.SMNH/.SdC/.estacion/.Analyses/.Tailored/.temperature/a:/.lon/:a:/.lat/2/copy/:a:/.historical/:a/SOURCES/.WORLDBATH/.bath/-1/min/6/-5/roll/X/Y/fig-/white/mask/black/coasts_gaz/thin/countries_gaz/grey/verythin/states_gaz/lightgrey/scatter/scattercolor/-fig//plotaxislength/150/psdef//XOVY/null/psdef//antialias/true/psdef//fntsze/30/psdef//percentile/0.1/plotvalue//plotborder/0.0/psdef//X/-89.5/-83/plotrange//Y/12.5/17/plotrange/+.gif" />
<style>
.dlimgtsbox {
width: 99%;
...
<input class="pickarea dlimg dlauximg share" name="resolution" type="hidden" data-default="irids:SOURCES:SMNH:SdC:estacion:historical:ds" />
...
<input class="dlimg dlauximg share dlimgts" name="hotThreshold" type="hidden" data-default="0." />
<input class="dlimg dlauximg share dlimgts pET ylyStat bodyClass" name="seasonalStat" type="hidden" data-default="MeanTemp" />
<input class="dlimg dlauximg share ylyStat perc pET bodyClass" name="yearlyStat" type="hidden" data-default="Mean" />
<input class="dlimg share pET" name="probExcThresh1" type="hidden" data-default="0." />
<input class="dlimg share pET" name="probExcThresh2" type="hidden" data-default="0." />
<input class="dlimg share pET" name="probExcThresh3" type="hidden" data-default="100." />
<input class="dlimg share pET" name="probExcThresh4" type="hidden" data-default="30." />
<input class="dlimg share pET" name="probExcThresh5" type="hidden" data-default="30." />
</form>
...
<a class="station" rel="iridl:hasJSON" href="http://iridl.ldeo.columbia.edu/expert/%28bb:1:2:3:4:bb%29//region/parameter/geoobject/info.json"></a>
<div class="template">
Observations for <span class="bold iridl:long_name"></span>
</div>
</div>
<div class="valid" style="text-align: top;">
<a class="station" rel="iridl:hasJSON" href="http://iridl.ldeo.columbia.edu/expert/SOURCES/.SMNH/.SdC/.estacion/.historical/estacion/%28irids:SOURCES:SMNH:SdC:estacion:historical:estacion%40Amapala:ds%29//region/parameter/geoobject/.estacion/.first/VALUE/lon/lat/2/ds/info.json"></a>
...
<img class="dlimg" rel="iridl:hasFigureImage" src="http://iridl.ldeo.columbia.edu/expert/SOURCES/.SMNH/.SdC/.estacion/.Analyses/.Tailored/.temperature/a:/.lon/:a:/.lat/2/copy/:a:/.historical/:a/SOURCES/.WORLDBATH/.bath/-1/min/6/-5/roll/X/Y/fig-/white/mask/black/coasts_gaz/thin/countries_gaz/grey/verythin/states_gaz/lightgrey/scatter/scattercolor/-fig//plotaxislength/500/psdef//XOVY/null/psdef//antialias/true/psdef//fntsze/30/psdef//percentile/0.1/plotvalue//X/-89.5/-83/plotrange//Y/12.5/17/plotrange/+.gif" border="0" />
<img class="dlauximg" rel="iridl:hasFigureImage" src="http://iridl.ldeo.columbia.edu/expert/SOURCES/.SMNH/.SdC/.estacion/.Analyses/.Tailored/.temperature/a:/.lon/:a:/.lat/2/copy/:a:/.historical/:a/SOURCES/.WORLDBATH/.bath/-1/min/6/-5/roll/X/Y/fig-/white/mask/black/coasts_gaz/thin/countries_gaz/grey/verythin/states_gaz/lightgrey/scatter/scattercolor/-fig//plotaxislength/500/psdef//XOVY/null/psdef//antialias/true/psdef//fntsze/30/psdef//percentile/0.1/plotvalue//X/-89.5/-83/plotrange//Y/12.5/17/plotrange/.auxfig+.gif" />
</fieldset>
...
<p>
Permite elegir muchas opciones para producir series temporales anuales de un análisis estacional particular de los datos de temperatura diarios. Permite hacer el mapa del promedio, la desviación típica, la probabilidad de excedencias un límite elegido, el coeficiente de variación o el valor de algunos percentiles predefinidos, para el rango de años elegidos. Hacer un click en el mapa produce una serie temporal local del análisis elegido.
</p>
</div>
...
la suma de días cálidos o fríos durante la estación según un límite elegido y respectivamente la temperatura máxima y la temperatura mínima.
<br />
...
una elección de estadísticas anuales para la estación y el rango de años elegidos que hace el mapa de : el promedio, la desviación típica, la probabilidad de excedencias un límite especificado, el coeficiente de variación o el valor de un percentil elegido.
</p>
</div>

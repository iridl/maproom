...
ob.className="iriicon";
        if(document.width < 750){
ob.innerHTML='<img class="iriicon" src="iri32.png" />';
}
else {
ob.innerHTML='<img class="iriicon" src="iri.png" />';
}
gb.appendChild(ob);
